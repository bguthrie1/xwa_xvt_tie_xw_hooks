...
namespace Hook_TourMultiplayer
{
    static class TourMultiplayer
    {
        public static int TourMultiplayerHook(IntPtr @params)
        {
            ...
            // Imperial Wingmen voice fix (not necessary due to Jeremy's Wingmen Voice hook)
            //IntPtr bufferPtr1 = new IntPtr(0x5B4078);
            //IntPtr bufferPtr2 = new IntPtr(0x43B89C);
            //IntPtr bufferPtr3 = new IntPtr(0x692FF5);
            //IntPtr bufferPtr4 = new IntPtr(0x43B822);
            ...
            IntPtr bufferPtr121 = new IntPtr(0x692C20);
            ...
            */
            ...
            // Imperial Wingmen voice fix
            //byte[] hex1 = HexStringToByteArray.StrToByteArray("495025642E4C5354"); // Changes the voice to look for from ISP1.LST to IP%d.LST which allows it to randomly load an imperial pilot with a number
            //byte[] hex2 = HexStringToByteArray.StrToByteArray("E954772500"); // Replaces point where it loads the string for a random Rebel pilot and jumps to a new custom function
            //byte[] hex3 = HexStringToByteArray.StrToByteArray("A1C81C8C0069C0CF0B00006683B8EA948B0001750A6878405B00E98D88DAFF6868405B00E98388DAFF"); // Pushes a string that either loads random rebel or imperial pilot voices depending on player IFF. 
            //byte[] hex4 = HexStringToByteArray.StrToByteArray("EB28"); // Skip Imperial IFF check to allow new function to work. Will need to look at this again in order to allow specific Imperial pilot voices
            ...
            //byte[] hex120 = HexStringToByteArray.StrToByteArray("E96CB814009090"); // Changes Clear button function to Load campaign/tour screen if not Skirmish part 1
            //byte[] hex121 = HexStringToByteArray.StrToByteArray("833D8A2AAE00037429C605537BB00001C6059E2AAE0004C605C84B9F0005C705484B9F0003000000E8B34BEBFFE9EB47EBFF6A14E8F79EECFFE95847EBFF"); // Changes Clear button function to Load campaign/tour screen if not Skirmish part 2
            ...
            // Imperial Wingmen voice fix
            //Marshal.Copy(hex1, 0, bufferPtr1, hex1.Length);
            //Marshal.Copy(hex2, 0, bufferPtr2, hex2.Length);
            //Marshal.Copy(hex3, 0, bufferPtr3, hex3.Length);
            //Marshal.Copy(hex4, 0, bufferPtr4, hex4.Length);
            ...
            bool getbackgroundvalue = Readcfg.ParseNumberFile();
