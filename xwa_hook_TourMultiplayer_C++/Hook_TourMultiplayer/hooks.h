...
static const HookFunction g_hookFunctions[] =
{
	...
	{ 0x4C292E, IFFColorCraftListNames },
...
static const HookPatchItem g_multiPatch[] =
{
	...
	// Entry
	{ 0x127FBB, "BF602AAE00", "E860FF0700" },
	{ 0x127FC0, "68201F6000", "E915A41600" },

	// Combat Button Hook
	{ 0x145E00, "0F8460010000", "E81B21060090" },
	
	// IFF Color Craft Species Hook
	{ 0x723D5, "84C075046A51EB1E3C017418", "E8465B130090EB1C3C017418" },

	// IFF Color Craft Name Hook
	{ 0x724B3, "84C075046A52EB1E3C017418", "E8685A130090EB1C3C017418" },

	// IFF Color FG Species hook
	{ 0x72791, "84DB75046A51EB2280FB01", "E88A57130090EB2080FB01" },
	
	// IFF Color FG Name Hook
	{ 0x72829, "84DB75046A52EB2280FB01", "E8F256130090EB2080FB01" },

	// IFF Color Player Target Box Hook
	{ 0x102CB4, "83F8047713FF2485103A5000", "E867520A0090909090909090" },

	// IFF Color Map Player Target Box Hook
	{ 0x9EE29, "7719", "9090" },
	{ 0x9EE2B, "FF24858C044A00", "E8F09010009090" },

	// IFF Color FG Map marker hook
	{ 0x9F25C, "7723", "9090" },
	{ 0x9F25E, "FF2485A0044A00", "E8BD8C10009090" },

	// IFF Craft Names List Hook
	{ 0xC1D29, "75046A52EB1E3C017418", "E8F2610E009090EB1B90" },
...
{
	MAKE_HOOK_PATCH("Tour Multiplayer Patch", g_multiPatch),
};
