...
const auto UI_CreateClickableText = (int(*)(int, int, char* buffer, int, int highlightColor, int, int, char* sound))0x556100;
...
const auto TryLoadFrontResEntryForceEncode = (void**(*)(char* resFileName, char* resName))0x531D70;
const auto DrawDatapadFrontResRLETransparent = (int(*)(char* resName, int xPos, int yPos))0x534A60;
...
const auto CreateImage = (int(*)(char* image, int size))0x5322F0;
const auto CreateRectBasedOnResData = (int(*)(char* resData, RECT* rect))0x532180;
